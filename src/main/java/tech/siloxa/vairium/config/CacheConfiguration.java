...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            createCache(cm, tech.siloxa.vairium.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            createCache(cm, tech.siloxa.vairium.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
